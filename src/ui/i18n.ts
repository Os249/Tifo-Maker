...
const STRINGS: Record<string, { en: string; ar: string }> = {
  ...
  'bn.a11y.width': { en: 'Width in metres', ar: 'العرض بالأمتار' },
  'bn.a11y.height': { en: 'Height in metres', ar: 'الارتفاع بالأمتار' },
  'bn.a11y.gsm': { en: 'Fabric weight', ar: 'وزن القماش' },
  'bn.a11y.brush': { en: 'Brush width in centimetres', ar: 'عرض الفرشاة بالسنتيمترات' },

  'bn.kind.drop': { en: 'Drop banner', ar: 'لافتة منسدلة' },
  'bn.kind.lift': { en: 'Rope lift', ar: 'لافتة تُرفع بالحبال' },
  'bn.kind.pass': { en: 'Crowd pass', ar: 'لافتة تمر فوق الجمهور' },
  'bn.kind.roof': { en: 'Roof-hung', ar: 'معلّقة من السقف' },
  'bn.kind.cover': { en: 'Stand cover', ar: 'غطاء المدرج' },
  'bn.kind.fence': { en: 'Fence banner', ar: 'لافتة السياج' },
  'bn.kind.pitch': { en: 'Pitch banner', ar: 'لافتة أرضية' },
  'bn.kind.pole': { en: '3D pole-out', ar: 'ثلاثية الأبعاد بأعمدة' },
  ...
  'bn.span.free': { en: 'Free placement', ar: 'وضع حر' },
  ...
  'bn.fit.cut': {
    en: '{w}x{h} m does not fit here — cut to {fw}x{fh} m',
    ar: '{w}x{h} م ما يسعون هنا — تم تصغيرها إلى {fw}x{fh} م',
  },
  'bn.along': { en: 'Along', ar: 'بالعرض' },
  'bn.up': { en: 'Up', ar: 'للأعلى' },
  'bn.out': { en: 'Out', ar: 'للأمام' },
  'bn.tilt': { en: 'Lean', ar: 'الميلان' },
  'bn.centre': { en: 'Centre it', ar: 'وسّطها' },
  'bn.centreT': { en: 'Put it dead centre on the stand', ar: 'حطّها بالضبط في منتصف المدرج' },
  'bn.fitStand': { en: 'Fit the stand', ar: 'على مقاس المدرج' },
  'bn.fitStandT': { en: 'Size it to the stand it is on', ar: 'خلّي مقاسها على قد المدرج اللي عليه' },
  ...
  'bn.rev.drop': { en: 'Unroll downward', ar: 'تنفرد للأسفل' },
  'bn.rev.lift': { en: 'Haul up on ropes', ar: 'تُسحب للأعلى بالحبال' },
  'bn.rev.pass': { en: 'Passed over the crowd', ar: 'تمرّ فوق رؤوس الجمهور' },
  'bn.rev.hoist': { en: 'Lowered from the roof', ar: 'تنزل من السقف' },
  'bn.rev.unfold': { en: 'Unfold on poles', ar: 'تنفتح على الأعمدة' },
  'bn.rev.fade': { en: 'Already in place', ar: 'موجودة من قبل' },
  ...
  'bn.msg.fitStand': { en: 'Sized to the stand: {w} × {h} m.', ar: 'انضبط المقاس على المدرج: {w} × {h} م.' },
  'bn.msg.fitStandGuess': { en: 'Open Match Day once and this can measure the real stand.', ar: 'افتح يوم المباراة مرة وبيقدر يقيس المدرج الحقيقي.' },
