...
const STRINGS: Record<string, { en: string; ar: string }> = {
  ...
  'auth.usernamePh': { en: '3–24 letters, digits, _', ar: '٣–٢٤ حرفًا أو رقمًا أو _' },
  ...
  'auth.accept': { en: 'I am 18 or older and agree to the', ar: 'عمري ١٨ سنة أو أكثر وأوافق على' },
  ...
  'auth.errUsername': { en: 'Username must be 3–24 characters: letters, digits, or underscore.', ar: 'اسم المستخدم يجب أن يكون ٣–٢٤ حرفًا: أحرف أو أرقام أو شرطة سفلية.' },
  ...
  'auth.errAccept': { en: 'Please confirm you are 18+ and agree to the Terms and Privacy Policy.', ar: 'يرجى تأكيد أنك ١٨ سنة أو أكثر وموافقتك على الشروط وسياسة الخصوصية.' },
