...
const STRINGS: Record<string, { en: string; ar: string }> = {
  ...
  'ed.camera.banner': { en: 'Your banner', ar: 'لافتتك' },
  ...
  'si.help': { en: 'Type the ground’s own name — “Anfield”, “Old Trafford”, “King Fahd International Stadium”. Not the club, not the city. If nothing comes up, add the city (“Camp Nou Barcelona”) or use the full official name.', ar: 'اكتب اسم الملعب نفسه — “استاد الملك فهد الدولي”، “Anfield”. مو اسم النادي ولا المدينة. للملاعب الكبيرة استخدم كلمة «استاد» مو «ملعب»؛ الخريطة تسجّلها كذا. وإذا ما طلع شي، زيد اسم المدينة أو جرّب الاسم بالإنجليزي.' },
  ...
  // Under a ground built from a real venue. Same substance as the legal page's
  // non-affiliation line, in the same words where it can be.
  'sp.disclaimer': { en: 'Inspired by a real-world venue. This template is not affiliated with, endorsed by, or officially connected to any club, stadium owner, or venue operator.', ar: 'مستوحى من ملعب حقيقي. هذا القالب ما له أي ارتباط أو اعتماد أو صلة رسمية بأي نادي أو مالك ملعب أو جهة تشغّل الملعب.' },
  ...
  'cm.badgeBanners': { en: 'With banners', ar: 'فيه لافتات' },
  'cm.camBanner': { en: 'The banner', ar: 'اللافتة' },
  'cm.camBannerT': { en: 'Look at this banner', ar: 'شوف هذي اللافتة' },
  'tag.banners': { en: 'with banners', ar: 'فيه لافتات' },
  ...
  'stad.grandNational': { en: 'Grand National Bowl', ar: 'المدرج الوطني الكبير' },
  'stad.steepCauldron': { en: 'Steep Cauldron', ar: 'المرجل شديد الانحدار' },
  'stad.compactWall': { en: 'Compact Wall', ar: 'الجدار المتراص' },
  'stad.desertArena': { en: 'Desert Arena', ar: 'ملعب الصحراء' },
  'stad.roaringTerraces': { en: 'Roaring Terraces', ar: 'المدرجات الهادرة' },
  ...
  'bn.signN': { en: 'Sign {n}', ar: 'يافطة {n}' },
  'bn.newT': { en: 'New banner', ar: 'لافتة جديدة' },
  'bn.delT': { en: 'Delete this banner', ar: 'احذف هذي اللافتة' },
  'bn.renameT': { en: 'Rename this banner', ar: 'غيّر اسم هذي اللافتة' },
  'bn.nameA': { en: 'Banner name', ar: 'اسم اللافتة' },
  ...
  'bn.none.body': { en: 'Banners are optional. Make one when you want one: a stand banner is unrolled over the seats, a hanging banner is hauled up on ropes, and a sign is a message held up by the fans.', ar: 'اللافتات اختيارية. سوّ وحدة إذا تبغى: لافتة المدرج تنفرد على المقاعد، واللافتة المعلّقة تنسحب للأعلى بالحبال، واليافطة رسالة يرفعها الجمهور.' },
  ...
  // ---- banners: the first-time tour of the Banner view ----
  'btour.aria': { en: 'How banners work', ar: 'كيف تشتغل اللافتات' },
  'btour.replay': { en: 'How banners work', ar: 'كيف تشتغل اللافتات' },
  'btour.replayT': { en: 'Show the banner tour again', ar: 'اعرض جولة اللافتات مرة ثانية' },
  'btour.intro': { en: 'This is the Banner view', ar: 'هذا عرض اللافتات' },
  'btour.intro.b': { en: 'A banner is a big printed sheet the crowd shows in the stand, separate from the seat cards. You draw it here, and it goes up in the stadium.', ar: 'اللافتة قماشة كبيرة مطبوعة يرفعها الجمهور في المدرج، وهي غير كروت المقاعد. ترسمها هنا، وتطلع في الملعب.' },
  'btour.make': { en: 'Make your first one', ar: 'سوّ أول وحدة' },
  'btour.make.b': { en: 'A stand banner is unrolled down over the seats. A hanging banner is hauled up on ropes. A sign is a message held up by a row of fans. A tifo can have several, or none at all.', ar: 'لافتة المدرج تنفرد على المقاعد. اللافتة المعلّقة تنسحب للأعلى بالحبال. اليافطة رسالة يرفعها صف من الجمهور. التيفو يقدر يكون فيه أكثر من وحدة، أو ولا وحدة.' },
  'btour.sheet': { en: 'The sheet', ar: 'القماشة' },
  'btour.sheet.b': { en: 'Its type, its size and its fabric. A see-through mesh lets the crowd behind it show through.', ar: 'نوعها ومقاسها وقماشها. الشبك الشفاف يخلّي الجمهور اللي وراها يبان.' },
  'btour.msg': { en: 'Its message', ar: 'رسالتها' },
  'btour.msg.b': { en: 'A sign says one thing. Type it here and it is painted across the sheet, as big as the sheet allows.', ar: 'اليافطة تقول شي واحد. اكتبه هنا وينكتب على طول القماشة، بأكبر حجم تسمح فيه.' },
  'btour.draw': { en: 'Draw on it', ar: 'ارسم عليها' },
  'btour.draw.b': { en: 'The same tools as the seats: brush, fill, text, shapes and images all work on the banner.', ar: 'نفس أدوات المقاعد: الفرشاة والتعبئة والنص والأشكال والصور كلها تشتغل على اللافتة.' },
  'btour.list': { en: 'Every banner in this tifo', ar: 'كل لافتات هذا التيفو' },
  'btour.list.b': { en: 'Switch between them here, or make another. "Show in stadium" takes you straight to the stadium, looking at that banner.', ar: 'تنقّل بينها من هنا، أو سوّ وحدة ثانية. «اعرضها في الملعب» تنقلك للملعب والكاميرا على اللافتة.' },
  'btour.place': { en: 'Where it hangs', ar: 'وين تتعلّق' },
  'btour.place.b': { en: 'Choose the stand, the blocks it covers and the tier. Its size follows from the seats underneath, in real metres.', ar: 'اختر المدرج والبلوكات اللي تغطيها والطابق. مقاسها يتحدد من المقاعد اللي تحتها، بالمتر الحقيقي.' },
  'btour.reveal': { en: 'Match day', ar: 'يوم المباراة' },
  'btour.reveal.b': { en: 'Choose how it is revealed, then "See it on match day" plays it in a full stadium. The camera starts on your banner; drag to look around.', ar: 'اختر كيف تنكشف، وبعدها «شوفها يوم المباراة» تعرضها في ملعب مليان. الكاميرا تبدأ على لافتتك، واسحب عشان تتلفّت.' },
  'btour.again': { en: 'Whenever you want it', ar: 'متى ما تبغى' },
  'btour.again.b': { en: 'This tour is here if you want it again.', ar: 'الجولة هنا إذا تبغاها مرة ثانية.' },
  'btour.m.view': { en: 'This is the Banner view', ar: 'هذا عرض اللافتات' },
  'btour.m.draw': { en: 'Draw with a finger', ar: 'ارسم بإصبعك' },
  'btour.m.draw.b': { en: 'Paint, add text and shapes right on the sheet. Pinch to zoom.', ar: 'ارسم وأضف نص وأشكال على القماشة نفسها. قرّب بإصبعين.' },
  'btour.m.paint': { en: "The banner's settings", ar: 'إعدادات اللافتة' },
  'btour.m.paint.b': { en: 'Its type, size, where it hangs and "See it on match day" are all in Paint.', ar: 'نوعها ومقاسها ووين تتعلّق و«شوفها يوم المباراة» كلها في «الرسم».' },
  // ---- what's new: told once, to everyone who opens the editor ----
  'news.aria': { en: "What's new", ar: 'الجديد' },
  'news.tag': { en: 'New', ar: 'جديد' },
  'news.title': { en: 'Banners are here', ar: 'وصلت اللافتات' },
  'news.body': { en: 'Draw a stand banner, a hanging banner or a sign with your message, put it anywhere in the stadium, and watch it go up on match day.', ar: 'ارسم لافتة مدرج أو لافتة معلّقة أو يافطة فيها رسالتك، حطها في أي مكان بالملعب، وشوفها ترتفع يوم المباراة.' },
  'news.try': { en: 'Try banners', ar: 'جرّب اللافتات' },
  'news.later': { en: 'Not now', ar: 'مو الحين' },
  'news.close': { en: 'Close', ar: 'إغلاق' },
  ...
  'bn.size.is': { en: '{w} × {h} m on this ground', ar: '{w} × {h} م في هذا الملعب' },
  'bn.size.about': { en: 'about {w} x {h} m', ar: 'حوالي {w} × {h} م' },
  'bn.measures': { en: 'Measures', ar: 'المقاس' },
  'bn.m': { en: 'm', ar: 'م' },
  ...
  'bn.clear': { en: 'See-through', ar: 'شفّاف' },
  ...
  'bn.placeHint': { en: 'click the banner to place it', ar: 'اضغط على اللافتة عشان تحطّها' },
  'bn.placeTextHint': {
    en: 'pick a colour, then click the banner — it lands at a size that reads across the pitch',
    ar: 'اختر لون، وبعدين اضغط على اللافتة — بتنحط بمقاس ينقرأ من الطرف الثاني',
  },
  // The legible-type band across the top of the artboard.
  'bn.capBand': { en: 'headline at least {m} m tall', ar: 'العنوان {m} م أو أطول' },

  // The thing selected on the banner, and what you can do to it.
  'bn.item': { en: 'Selected', ar: 'المحدّد' },
  'bn.item.tag': { en: 'on the banner', ar: 'على اللافتة' },
  'bn.item.text': { en: 'Text: {t}', ar: 'نص: {t}' },
  'bn.item.shape': { en: 'Shape', ar: 'شكل' },
  'bn.item.image': { en: 'Picture', ar: 'صورة' },
  'bn.item.stroke': { en: 'Brush stroke', ar: 'ضربة فرشاة' },
  'bn.item.patch': { en: 'Fill', ar: 'تعبئة' },
  'bn.item.front': { en: 'Front', ar: 'قدّام' },
  'bn.item.frontT': { en: 'Bring it in front of everything else', ar: 'جيبها قدّام كل شي' },
  'bn.item.back': { en: 'Back', ar: 'ورا' },
  'bn.item.backT': { en: 'Send it behind everything else', ar: 'رجّعها ورا كل شي' },
  'bn.item.dup': { en: 'Duplicate', ar: 'كرّر' },
  'bn.item.dupT': { en: 'Duplicate it (Ctrl+D)', ar: 'كرّرها (Ctrl+D)' },
  'bn.item.del': { en: 'Delete', ar: 'احذف' },
  'bn.item.delT': { en: 'Delete it (Delete key)', ar: 'احذفها (زر Delete)' },
  'bn.msg.deleted': { en: 'Taken off the banner.', ar: 'انشالت من اللافتة.' },
  'bn.msg.duplicated': { en: 'Duplicated — drag the copy where you want it.', ar: 'تكرّرت — اسحب النسخة للمكان اللي تبيه.' },

  'bn.kind.stand': { en: 'Stand banner', ar: 'لافتة المدرج' },
  'bn.kind.sign': { en: 'Sign', ar: 'يافطة' },
  // ---- signs: a message held up by the fans ----
  'bn.add.signT': { en: 'Make a sign: a message held up by a row of fans', ar: 'سوّ يافطة: رسالة يرفعها صف من الجمهور' },
  'bn.sign.length': { en: 'Length', ar: 'الطول' },
  'bn.sign.height': { en: 'Height', ar: 'الارتفاع' },
  'bn.sign.m': { en: '{m} m', ar: '{m} م' },
  'bn.sign.msg': { en: 'Message', ar: 'الرسالة' },
  'bn.sign.msgTag': { en: 'painted on the sign', ar: 'مكتوبة على اليافطة' },
  'bn.sign.msgPh': { en: 'What does it say?', ar: 'وش مكتوب عليها؟' },
  'bn.sign.msgA': { en: "The sign's message", ar: 'رسالة اليافطة' },
  'bn.sign.font': { en: 'Letters', ar: 'الحروف' },
  'bn.sign.colorA': { en: 'Colour of the letters', ar: 'لون الحروف' },
  'bn.sign.default': { en: 'YOUR MESSAGE HERE', ar: 'رسالتكم هنا' },
  'bn.sign.row': { en: 'Held at', ar: 'وين تنرفع' },
  'bn.sign.fence': { en: 'Tied to the front fence', ar: 'مربوطة على السياج الأمامي' },
  'bn.sign.balcony': { en: 'Tied to the front of the tier', ar: 'مربوطة على حافة الطابق' },
  'bn.sign.rowFront': { en: 'Row 1 — the front', ar: 'الصف ١ — الأمامي' },
  'bn.sign.rowN': { en: 'Row {n}', ar: 'الصف {n}' },
  'bn.sign.rowBack': { en: 'Row {n} — the back', ar: 'الصف {n} — الأخير' },
  'bn.sign.at': { en: 'Along', ar: 'على امتداد' },
  'bn.sign.atMiddle': { en: 'The middle of the stand', ar: 'نص المدرج' },
  'bn.sign.atBlock': { en: 'In front of block {n}', ar: 'قدام القطاع {n}' },
  'bn.sign.atAisle': { en: 'Between blocks {a} and {b}', ar: 'بين القطاع {a} والقطاع {b}' },
  'bn.sign.heldBy': { en: 'held by {n} fans', ar: 'يرفعها {n} مشجع' },
  'bn.sign.tied': { en: 'tied to the fence', ar: 'مربوطة على السياج' },
  'bn.sign.long': { en: 'Longer than this stand, so it is cut to {w} m.', ar: 'أطول من المدرج، فانقصّت إلى {w} م.' },
  'bn.facts.sign': { en: '{hold} · {kg} kg · letters up to {cap} m', ar: '{hold} · {kg} كجم · الحروف لين {cap} م' },
  'bn.rev.raise': { en: 'Raised by the crowd', ar: 'يرفعها الجمهور' },
  'bn.msg.signAdded': { en: 'New sign added. Write its message, then choose where it is held.', ar: 'انضافت يافطة جديدة. اكتب رسالتها، وبعدين اختر وين تنرفع.' },
  'bn.note.signHeld': {
    en: 'Held by about {people} fans, one every {gap} m along its top edge.',
    ar: 'يرفعها تقريباً {people} مشجع، واحد كل {gap} م على طول حافتها.',
  },
  'bn.note.signTied': {
    en: 'Tied to the fence with about {ties} cable ties — one every half metre.',
    ar: 'تنربط على السياج بحوالي {ties} رباط — واحد كل نص متر.',
  },
  'bn.note.signReads': {
    en: 'Letters {cap} m tall read from about {m} m — the far side of the pitch is about {far} m away.',
    ar: 'حروف بطول {cap} م تنقرأ من حوالي {m} م — الطرف الثاني من الملعب تقريباً على بعد {far} م.',
  },
  'bn.note.signShort': {
    en: 'Letters {cap} m tall read from about {m} m, short of the {far} m across the pitch. A taller sheet reads further.',
    ar: 'حروف بطول {cap} م تنقرأ من حوالي {m} م بس، أقل من {far} م عرض الملعب. اليافطة الأعلى تنقرأ من أبعد.',
  },
  ...
  // Which two: the window runs from the chosen stand to the next one round.
  'bn.across.pair': { en: '{a} and {b}, round the corner', ar: '{a} و{b}، حول الزاوية' },
  'bn.block': { en: 'Blocks', ar: 'القطاعات' },
  'bn.howMany': { en: 'How many', ar: 'كم قطاع' },
  ...
  'bn.netT': {
    en: 'A rope net sewn behind the sheet takes the load on a big banner. It is behind the fabric, so you will not see it from the pitch.',
    ar: 'شبكة حبال مخيّطة ورا القماش تشيل الحمل عن اللافتة الكبيرة. هي ورا القماش، فما تبان من الملعب.',
  },
  'bn.barT': { en: 'A weighted bar in the bottom hem, so the sheet hangs straight', ar: 'قضيب ثقيل في الحافة السفلية، عشان القماش ينزل مستقيم' },
  'bn.secs.v': { en: '{s} s', ar: '{s} ث' },
  'bn.secs.real': { en: 'The real one takes {s} s.', ar: 'الحقيقية تاخذ {s} ث.' },
  'bn.secs.useReal': { en: 'Use the real time', ar: 'استخدم الوقت الحقيقي' },
  ...
  'bn.note.clear': {
    en: 'See-through fabric: only what you draw on it will show in the stadium.',
    ar: 'قماش شفّاف: بس اللي ترسمه عليه بيبان في الملعب.',
  },
  'bn.note.empty': {
    en: 'It is see-through and nothing is drawn on it yet, so there is nothing to see in the stadium.',
    ar: 'هي شفّافة وما انرسم عليها شي، فما في شي يبان في الملعب.',
  },
...
const LABEL_KEYS: Record<string, string> = {
  ...
  'Grand oval 76k': 'stad.oval76k',
  'community-grand-national-80k': 'stad.grandNational',
  'community-steep-cauldron-55k': 'stad.steepCauldron',
  'community-compact-wall-30k': 'stad.compactWall',
  'community-desert-arena-68k': 'stad.desertArena',
  ...
  'Steep Cauldron': 'stad.steepCauldron',
  'Compact Wall': 'stad.compactWall',
  'Desert Arena': 'stad.desertArena',
  'Roaring Terraces': 'stad.roaringTerraces',
  'Cauldron Dome': 'stad.cauldronDome',
  'Wide Athletics Oval': 'stad.wideOval',
  'The Jewel of Jeddah': 'stad.jewelJeddah',
  'Al-Awwal Park (Riyadh)': 'stad.alAwwal',
  'Kingdom Arena (Riyadh)': 'stad.kingdomArena',
