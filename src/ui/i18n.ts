...
const STRINGS: Record<string, { en: string; ar: string }> = {
  ...
  'btour.make.b': { en: 'A stand banner is unrolled down over the seats. A hanging banner is hauled up on ropes. A tifo can have several, or none at all.', ar: 'لافتة المدرج تنفرد على المقاعد. اللافتة المعلّقة تنسحب للأعلى بالحبال. التيفو يقدر يكون فيه أكثر من وحدة، أو ولا وحدة.' },
  ...
  'news.body': { en: 'Draw a stand banner or a hanging banner, put it on any stand, and watch it unroll on match day.', ar: 'ارسم لافتة مدرج أو لافتة معلّقة، حطها على أي مدرج، وشوفها تنفرد يوم المباراة.' },
