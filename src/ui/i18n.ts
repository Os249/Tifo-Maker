...
const STRINGS: Record<string, { en: string; ar: string }> = {
  ...
  'ed.colors.wellT': { en: 'Active paint color: click to change', ar: 'لون الرسم الحالي: اضغط عشان تغيّره' },
  'ed.colors.addT': { en: 'Pick any color and add it to your swatches', ar: 'اختر أي لون وأضفه لألوانك' },
